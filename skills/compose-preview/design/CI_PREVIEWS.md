...
jobs:
  update:
    ...
    steps:
      ...
      - uses: yschimke/compose-ai-tools/.github/actions/preview-baselines@v0.8.0
        with:
          cli-version: catalog   # or "latest", or a literal "0.8.0"
```
    ...
    steps:
      ...
      - uses: actions/setup-java@v5
        with:
          ...
          java-version: 17
      - uses: gradle/actions/setup-gradle@v6
      - uses: yschimke/compose-ai-tools/.github/actions/preview-comment@v0.8.0
        with:
          cli-version: catalog
```
<!-- x-release-please-end -->
